...
async function viewTodosForDate(date: string): Promise<void> {
...
async function viewTodosForSpecificDate(): Promise<void> {
...
async function markTodoAsComplete(): Promise<void> {
